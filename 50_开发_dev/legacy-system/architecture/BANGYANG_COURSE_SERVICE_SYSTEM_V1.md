...
## 九、网络检索补充(内容层;来源=Baidu 检索聚合,**E2/E3,含推广口径,须核验**)
```text
PROVENANCE   = web_search(Baidu)聚合;THIRD_PARTY + PROMOTIONAL 混合;非 primary、非 decisive
CAVEAT       = 满意度/改善率均为【推广自述】,不得当事实(NON_DECISIVE);存在退费/营销投诉,品牌口碑混合
USE          = 仅补 FELS 课程"结构骨架"的真实命名/时长/工具,不作 Outcome/效果证据
```
- **创始人/IP = 波波校长**(战略文档 S1–S4 未提,网络检索确认):提出**「父母二次成长」理论**——"孩子行为问题是表象,根源在父母的认知模式、情绪模式、关系模式"。
- **课程阶梯(真实命名/价格/时长)**:
  - 入门:**5天好爸妈训练营(¥99)**——社群+直播,每日学习任务;工具例:**情绪五维法、移情图**。
  - 核心:**21天智慧父母训练营(¥4980)**——系统深入(主题片段:修正孩子消极思维 / 修复破裂亲子关系 / 建立顺畅沟通)。
  - 高阶:**点亮心灯训练营** 等。
- **三维成长框架**:自我关系 + 他人关系 + **财富关系**(较 S1/S2 的"孩子/家长/关系"更宽,含家长自身财富/生命议题)。
- **服务特色**:线上+线下双轨 · 助教全程答疑 · 社群陪伴 · 顾问个性化指导 · **每日打卡**。
- 成立 2011,自称服务 100万+ 家庭(推广口径)。

> FELS 移植取用:课程阶梯命名(5天/21天/点亮心灯)+ 时长 + 工具名(情绪五维法/移情图)可作 Course/Program 的**结构与命名**;效果类自述(满意度/改善率)**一律不入库为事实**,如需保留则标 `provenance=promotional, decisive=false`(旧世界脏数据,FELS-4 诱饵)。仍缺**逐日课表/教案原文**(检索页未给),待官方教学材料再补。
