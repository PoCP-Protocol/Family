...
export interface AvatarRendererContract {
  ...
  readonly readonly state_mutation_forbidden: true;
  readonly readonly principal_semantic_mutation_forbidden: true;
  readonly readonly family_write_forbidden: true;
}

// Export type guards

export function isCharacterIdentity(obj: any): obj is CharacterIdentity {
  return obj?.version === 'character_v1.0' &&
    obj?.character_name === '法咪莉校长' &&
    obj?.bobo_identity_clone === false &&
    obj?.bobo_face_clone === false &&
    obj?.bobo_voice_clone === false;
}
