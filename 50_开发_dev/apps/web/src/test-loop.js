...
export function createTestLoopApp(root, config = defaultTestLoopConfig) {
  ...
  function corePlan() { return `${clearReference('growth-plan-90day-reference-434x1130.png', '90天成长方案：阶段信息、3/12/36/90统计、四周时间线、任务状态和开始执行计划', [['clear-bottom-cta', 'growth-daily-task', '查看今天的行动']], '434/1130')}${familyPlanLivePanel()}`; }
