...
export function createTestLoopApp(root, config = defaultTestLoopConfig) {
  ...
  function parentCommunity() { return clearReference('parent-community-reference-552x1034.png', '家长社区：搜索、话题、内容流与互动入口', [['clear-community-detail', 'ui25-open-exchange-detail', '阅读一段家庭经验'], ['clear-community-publish', 'llm-community-publish', '发布动态'], ['clear-community-mine', 'my-community', '我的社区']], '552/1034'); }
