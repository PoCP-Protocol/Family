...
export type FamilyNamedAction =
  ...
  | 'ReadFamilyDataGovernancePolicy' | 'SubmitFamilyDataLifecycleReview' | 'RecordFamilyDataLifecycleHumanDecision';
...
const MATRIX: Record<FamilyNamedAction, Record<FamilyRole, Decision>> = {
  ...
  // FAMILY-GROWTH-VERTICAL-SLICE-001：孩子可表达观点，但服务意图、资源选择与服务执行须由具备家庭责任的成人发起/确认。
  CreateGrowthIntent:          { OWNER_GUARDIAN: 'ALLOW', GUARDIAN: 'ALLOW', ADULT_MEMBER: 'LIMITED', CHILD_SUBJECT: 'DENY' },
  RequestResourceRecommendation:{ OWNER_GUARDIAN: 'ALLOW', GUARDIAN: 'ALLOW', ADULT_MEMBER: 'LIMITED', CHILD_SUBJECT: 'DENY' },
  DecideFamilyService:         { OWNER_GUARDIAN: 'ALLOW', GUARDIAN: 'ALLOW', ADULT_MEMBER: 'DENY',    CHILD_SUBJECT: 'DENY' },
  ...
  ReadFamilyDataGovernancePolicy:    { OWNER_GUARDIAN: 'ALLOW', GUARDIAN: 'ALLOW', ADULT_MEMBER: 'DENY',    CHILD_SUBJECT: 'DENY' },
  SubmitFamilyDataLifecycleReview:   { OWNER_GUARDIAN: 'ALLOW', GUARDIAN: 'ALLOW', ADULT_MEMBER: 'DENY',    CHILD_SUBJECT: 'DENY' },
  RecordFamilyDataLifecycleHumanDecision: { OWNER_GUARDIAN: 'ALLOW', GUARDIAN: 'DENY', ADULT_MEMBER: 'DENY', CHILD_SUBJECT: 'DENY' },
};
