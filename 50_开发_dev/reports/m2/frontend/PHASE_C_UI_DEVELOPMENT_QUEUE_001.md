...
| UI-34 | Service Records | Research/Needs、BA、Visual Brief、Architect Review、Blocking | `NEEDS_RESEARCH_REVIEW` | ServiceRecord 与 Outcome 区分、纠错和来源 | NO | NO | `RUNTIME_SCREENSHOT_READY=NO`; `PIXEL_DIFF_READY=NO` |
