...
M3_INT_001 = PASS_CLOSED (admitted to MOS; merged to master via PR#2 @fff1a5d)
M3_W1_FAMILI_PRINCIPAL_RUNTIME = PASS_CLOSED
FPAI_RUNTIME_ADMITTED_TO_MOS = YES
M3_RB_001 = PASS_CLOSED
M3_RB_002 = PASS_CLOSED
CURRENT_EXECUTION_GATE = M3-W2-000 (Consumer Integration Contract Gate)
M3_W2 = IN_PROGRESS
AUTHORIZATION_SSOT = governance/AUTHORIZATION_REGISTRY.yaml
EXECUTION_SSOT = V3.3
...
WAVE3_BLOCKERS = 0
# --- SSOT drift repair (GOV-001, 2026-08-12): M3-W1 已收口,内部受控 runtime 已入场;
# 以下保持"真实外呼/试点/生产"仍未授权,不因 runtime 入场而放开 ---
M3_INTERNAL_RUNTIME = ADMITTED_DETERMINISTIC_DEFAULT
REAL_EXTERNAL_MODEL_DEFAULT = OFF
PILOT_REAL_MODEL = NOT_AUTHORIZED
IMAGE_EXTERNAL = NOT_AUTHORIZED
PRODUCTION_PROVIDER = NOT_AUTHORIZED
F12_AI = NOT_STARTED
